...
class SuratMasuk extends Model
{
    ...
    /** @var array<string> */
    protected $searchableColumns = ['status', 'pengolah.nama_pengolah', 'sifat_naskah', 'jenis_surat.jenis_surat', 'nama_pengirim', 'jabatan_pengirim', 'instansi_pengirim', 'nomor_naskah', 'tgl_naskah', 'tgl_diterima', 'ringkasan_isi_surat'];
